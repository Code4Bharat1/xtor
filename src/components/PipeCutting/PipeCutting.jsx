          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 text-body text-justify">
              <p>
                ...
                OD of the in-line pipe or fittings for strong, stable clamping.
              </p>
              <br />
              <p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="py-8">
          <div>
            ...
            <div className="border border-gray-600 rounded-xl overflow-hidden shadow-2xl w-full max-w-7xl mx-auto mt-8">
                ...
                <table className="w-full border-collapse min-w-[850px] text-xs sm:text-sm">
                  <thead className="bg-gray-800 text-white">
                    <tr className="leading-tight font-bold text-xs sm:text-sm">
                      <th className="py-3 px-2 text-center border-r border-gray-700 w-[12%]" rowSpan="2">Model</th>
                      <th className="py-3 px-2 text-center border-r border-gray-700 w-[20%]" colSpan="2">Machine ID</th>
                      <th className="py-3 px-2 text-center border-r border-gray-700 w-[20%]" colSpan="2">Machine OD</th>
                      <th className="py-3 px-2 text-center border-r border-gray-700 w-[22%]" colSpan="2">Mounting Range</th>
                      <th className="py-3 px-2 text-center w-[26%]" colSpan="2">Ring Weight (Kg)</th>
                    </tr>
                    <tr className="font-medium text-gray-300 leading-tight text-[11px] sm:text-xs">
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">mm</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">Inch</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">mm</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-gray-600">Inch</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">mm</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">Inch</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t border-r border-gray-600">W/O Acc.</th>
                      <th className="py-2 px-1.5 text-center bg-gray-700 border-t">With Acc.</th>
                    </tr>
                  </thead>

                  <tbody>
                    {machineData.map((item, index) => (
                      <tr key={item.model} className="bg-black hover:bg-zinc-900/60 transition-colors text-center border-t border-gray-700 leading-normal">
                        <td className="py-2.5 px-2 font-medium text-center text-red-400 border-r border-gray-700 break-words">{item.model}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.machineIdMm}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.machineIdInch}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.machineOdMm}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.machineOdInch}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.mountingRangeMm}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-white break-words">{item.mountingRangeInch}</td>
                        <td className="py-2.5 px-1.5 text-center border-r border-gray-700 text-gray-300 break-words">{item.ringWeightWo}</td>
                        <td className="py-2.5 px-1.5 text-center text-gray-300 break-words">{item.ringWeightWith}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
